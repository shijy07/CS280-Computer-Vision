...
[mag,theta]=derivative_gaussian_filter(img,4,21);
figure;
...
figure;
subplot(1,3,1),imshow(theta1,[]);title('threshold: 0.4 of max mag');
subplot(1,3,2),imshow(theta2,[]);title('threshold: 0.6 of max mag');
subplot(1,3,3),imshow(theta3,[]);title('threshold: 0.8 of max mag');